...
INSERT INTO "wzusers" (`id`, `username`, `password`, `fullname`, `email`, `timezone`, `role`, `status`, `verification_key`, `email_verified`, `admin_verified`, `retry_count`, `all_accounts`) VALUES ("1","admin","77f9101246a0ca5e24a20ef8d06d19c83bbb69e4","Administrator", "","UTC","admin","1","","1","1","0","1");
