...
CREATE TABLE "wzusers" ("id" INTEGER PRIMARY KEY NOT NULL, "username" VARCHAR NOT NULL, "password" VARCHAR NOT NULL, "fullname" VARCHAR, "email" VARCHAR, "timezone" VARCHAR, "role" VARCHAR, "status" INTEGER NOT NULL, "verification_key" VARCHAR, "email_verified" INTEGER NOT NULL, "admin_verified" INTEGER NOT NULL, "retry_count" INTEGER NOT NULL, "all_accounts" INTEGER NOT NULL);
...
CREATE TABLE "wzuseraccounts" ("id" INTEGER PRIMARY KEY NOT NULL, "wzuser_id" INTEGER NOT NULL, "wzaccount_id" INTEGER NOT NULL, "role" VARCHAR);
