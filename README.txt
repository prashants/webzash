...
Step 2. Extract CakePHP into your web server directory and rename the folder to
"webzash"
...
Note : If you change the above security salt the default passwords will not work.
